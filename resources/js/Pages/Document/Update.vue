...
onMounted(() => {
    form.doc_nombre = props.documento.DOC_NOMBRE;
    form.doc_contenido = props.documento.DOC_CONTENIDO;
    form.doc_id_tipo = props.documento.DOC_ID_TIPO;
    form.doc_id_proceso = props.documento.DOC_ID_PROCESO;
});

function submit() {
    form.put(route('documento.update', props.documento.DOC_ID));
}
</script>
